...
class Bubble_Shooter_Test(unittest.TestCase):
	...
	# def test_build_adj_dict_three__bubbles(self):
	# 	bubble_1 = Bubble(fake_tk_picture, color="blue")
	# 	bubble_2 = Bubble(fake_tk_picture, color="yellow")
	# 	bubble_3 = Bubble(fake_tk_picture, color="red")
	...
	# def test_build_adj_dict_three__bubbles_same_color(self):
	# 	bubble_1 = Bubble(fake_tk_picture, color="blue")
	...
	# 	print result[bubble_1.color][1]
	# 	print expected[(bubble_1.color)][1]

	# 	self.assertEqual(len(result["blue"]), len(expected[bubble_3.color]))
	# 	self.assertTrue(result[bubble_1.color][1] is expected[(bubble_1.color)][0])
	# 	self.assertTrue(result[bubble_2.color][1] is expected[(bubble_2.color)][0])
	...
	# 	print result[bubble_1.color]
	# 	print expected[bubble_1.color]
		
	
	# 	self.assertEqual(len(result), len(expected))
	# 	self.assertTrue(result[bubble_1.color][0] is expected[bubble_1.color][1])
